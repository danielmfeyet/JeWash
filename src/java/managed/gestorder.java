...
public class gestorder {
    ...
    public void saveOrder() throws ParseException {
        ...
        order.setOrderdatecollect(dateplanification= new SimpleDateFormat("EEEE dd MMM yyyy", Locale.FRENCH).parse(newdate));
        order.setOrderdatedelivery(dateplanification1= new SimpleDateFormat("EEEE dd MMM yyyy", Locale.FRENCH).parse(newdate1));
    ...
    public void onCountryChange() throws ParseException {
        ...
        if (newdate != null) {
            Date f = new SimpleDateFormat("EEEE dd MMM yyyy", Locale.FRENCH).parse(newdate);
...
public String gototest2(String datedate) throws ParseException  
    {dateplanification= new SimpleDateFormat("EEEE dd MMM yyyy", Locale.FRENCH).parse(newdate);
    dateplanification1= new SimpleDateFormat("EEEE dd MMM yyyy", Locale.FRENCH).parse(newdate1);
